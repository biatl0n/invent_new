<?php
    ...
    $errMsg='';
	 ...
	 if ($_SERVER['REQUEST_METHOD']=='POST'){
        if(isset($_POST['delFromTrash'])){
            include 'inc/delFromTrash.inc.php';
        }
	 }
?>
    ...
    <tr>
       <!--  <td width="50%" height="500px" valign="top"> 
        ...
        <form id="delTehn" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <table border  id="table" width="97%" valign="top" style="margin:10px">
                <tr>
                    <th colspan="10"><h2>Удалённая техника</h2></th>
                </tr>
                <tr>
                    <th>N</th>
                    <th>Наименование</th>
            ...
            <table style="margin:10px;">
                <tr>
					...
					<td id="td_1"><input type="submit" name="delFromTrash" value="Удалить" onClick="onTehnDelete();"></td>
                </tr>
            </table>
        </form>
        </td>
