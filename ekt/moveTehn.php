    ...
    <tr>
        <td valign="top" width="50%">
            <table cellpadding="3px" border id="table">
                <tr>
                    <th colspan="3" align="center">Переместить </th>
                </tr>
                <tr>
                    <th>Категория</th>
                    <th>Модель</th>
			...
			<table cellpadding="3px" border id="table">
				<tr>
					...
					<td><input form="sel" type="date" readonly name="date_move" value="<?php echo date("Y-m-d");?>" /></td>
				</tr>
				<tr>
					<th>Кто переместил:</th>
					<td><input form="sel" readonly type="text" name="who_move" value="<?php echo $_SESSION['city']; ?>" /></td>
				</tr>
			</table>
			<form id="sel" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
				<input style="margin-left: 15px;" type="SUBMIT" name="movTehn"  value="Переместить">
			</form>
        </td>
        <td valign="top">
            <table cellpadding="3px" border id="table">
